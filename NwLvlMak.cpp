...
const byte WIMGOFFX=2;				// Numero di unitÖ a dx e a sx di quella
									// centrale nella finestra a grandezza
									// naturale.
const byte WIMGOFFY=2;				// Numero di unitÖ in alto e in basso
const byte WIMGX=(WIMGOFFX*2)+1;	// Larghezza e altezza complessiva in
const byte WIMGY=(WIMGOFFY*2)+1;	// numero di unitÖ
